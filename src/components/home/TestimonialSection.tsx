...
const testimonials = [
  ...
  },
  {
    ...
    msg: 'I extend my sincere gratitude for your exceptional support and expertise. Your unwavering dedication and strategic approach to my legal matters have made a significant impact. In navigating the complexities, your insights proved invaluable, providing clarity and assurance throughout. I appreciate the transparent communication and the personalized touch that set your firm apart. Thank you for going above and beyond, ensuring the best possible outcome.',
  },
  {
    name: 'Sandeep',
    title: 'Client',
        ...
        <div className="flex w-screen px-4 ">
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white lg:mx-10 rounded shadow dark:bg-gray-700">
