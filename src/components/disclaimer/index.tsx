      ...
      <div className="fixed inset-0 bg-primary-700 bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-[53]">
        <div className="flex justify-center items-center md:h-2/5 md:w-3/5 sm:text-sm h-2/4 w-3/4 ">
          <div className="relative flex flex-col rounded-md bg-white px-4 py-2 shadow-lg">
            ...
            <p className='text-md'>
            According to the regulations set forth by the Bar Council of India, Sethi & Associates (referred to as the &quotFirm&quot) is prohibited from engaging in solicitation or advertising activities. By selecting the "I Agree" option below, the user affirms the following:
            </p>
            <ul className='list-disc pl-3 mb-3'>
              ...
              <li>The user&aposs intent is to acquire information about the Firm solely for personal or professional informational purposes.</li>
