        ...
        <div className="flex justify-center items-center md:h-2/5 md:w-3/5 sm:text-sm h-2/4 w-3/4 ">
          <div className="relative flex flex-col rounded-md bg-white px-4 py-2 shadow-lg">
            ...
            <ul className="list-disc pl-3 mb-3">
              <li>
                The Firm and its members have refrained from engaging in any form of advertisement,
                personal communication, solicitation, invitation, or inducement via this website to
                procure work or promote services.
              </li>
              <li>
                The primary objective of this website is to furnish users with information
                pertaining to the Firm, including its practice areas, advocates, and solicitors.
              </li>
              <li>
                The user&aposs intent is to acquire information about the Firm solely for personal
                or professional informational purposes.
              </li>
              <li>
                Information regarding the Firm is dispensed to the user exclusively upon their
              ...
              <li>
                This website does not serve as an avenue for advertising or solicitation. The
                contents herein should not be construed as legal advice under any circumstances.
              </li>
              <li>
                The Firm disclaims liability for any consequences arising from actions taken by the
              ...
              <li>
                The content featured on this website is considered the intellectual property of the
                Firm.{' '}
              </li>
