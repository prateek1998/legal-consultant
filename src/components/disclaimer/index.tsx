    ...
    <>
      <div className="fixed inset-0 bg-primary-700 bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-[53]">
        <div className="flex justify-center items-center md:h-2/5 md:w-3/5 sm:text-sm h-2/4 w-[95%] ">
          <div className="relative flex flex-col rounded-md bg-white dark:bg-gray-800 px-4 py-2 shadow-lg">
            ...
            <ul className="list-disc pl-3 mb-3 h-80 overflow-y-auto">
              <p>
                1. The Firm and its members have refrained from engaging in any form of
                advertisement, personal communication, solicitation, invitation, or inducement via
                this website to procure work or promote services.
              </p>
              <p>
              ...
              <p>
                6. The Firm disclaims liability for any consequences arising from actions taken by
                the user based on the material or information provided on this website. Should the
                user require assistance, it is recommended to seek independent legal counselling.
              </p>
              <p>
